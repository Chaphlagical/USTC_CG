...
p1='D:\\USTC_CG\\Homeworks\\7_SimulationTaichi\\project\\bin\\Jelly_E_1e3'
...
p2='D:\\USTC_CG\\Homeworks\\7_SimulationTaichi\\project\\bin\\Jelly_E_1e4'
...
p3='D:\\USTC_CG\\Homeworks\\7_SimulationTaichi\\project\\bin\\Jelly_E_4e4'
...
for i in range(len(pic1_list)):
	...
	img1=cv.putText(img1, 'E:1e3', (100, 100), font, 1.2, (255, 255, 255), 2)
	img2=cv.putText(img2, 'E:1e4', (100, 100), font, 1.2, (255, 255, 255), 2)
	img3=cv.putText(img3, 'E:4e4', (100, 100), font, 1.2, (255, 255, 255), 2)
	#img4=cv.putText(img4, 'partical num:500000', (100, 100), font, 1.2, (255, 255, 255), 2)


	img=np.zeros([img1.shape[0],img1.shape[1]*3,3])
	img[0:img1.shape[0],0:img1.shape[1]]=img1
	img[0:img2.shape[0],img1.shape[1]:img2.shape[1]*2]=img2
	img[0:img2.shape[0],img1.shape[1]*2:img2.shape[1]*3]=img3
	#img[img3.shape[0]:img3.shape[0]*2,0:img3.shape[1]]=img3
	#img[img3.shape[0]:img3.shape[0]*2,img3.shape[1]:img3.shape[1]*2]=img4
	cv.imwrite('D:\\USTC_CG\\Homeworks\\7_SimulationTaichi\\project\\bin\\Jelly_E\\{:05d}.png'.format(i),img)
	cv.imshow("1",img1)
	cv.imshow("2",img2)
	#cv.imshow("3",img3)
	cv.imshow("4",img)
