...
void MiniDraw::Creat_Action()
{
	...
	connect(Action_About, &QAction::triggered, this, &MiniDraw::AboutBox);	Action_Default = new QAction(tr("&Default"), this);
	Action_Default->setIcon(QIcon(QString("../src/img/default.png")));	//	添加图标
	connect(Action_Default, &QAction::triggered, view_widget_, &ViewWidget::setDefault);
	...
	Action_Curve->setIcon(QIcon(QString("../src/img/curve.png")));
